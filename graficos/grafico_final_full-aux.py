...
# CROSS SECTION(S) (pb):
xsec    = [ 0.186818512E-03, 51.19, 0.13644263E+02]; #FIXME
#xsec = [ 1. , 1. , 1. , 1. , .1 ];

# PDF "_"+LABEL FOR OUTPUT FILES:
JOB     = "histos";
PDF     = [ 'superchic', 'MadGraph', 'FPMC']; #FIXME
...
#processo 3
FILES   = [
"amostras/newevrectest.dat", 'amostras/newunweighted_events.lhe', 'amostras/Artur_gammagammamumu-fpmc_elel_pt0_13p6tev.lhe'
]; #FIXME
...
histoslog_label  = ["protpz","proten",'protxi','protpt','mpp',"mupz","muen","mupt",'ivm_mu','phopz','phopt','phoen']; # add massa invariante
...
for i in range(len(FILES)):
    ...
    protxi.append(TH1D("1D_protxi"+"_"+PDF[i]       , "", 50,-0.001,0.4))
    ...
    ivm_mu.append(TH1D("1D_ivm_mu"+"_"+PDF[i]       , "", 50,-4., 40.0))
